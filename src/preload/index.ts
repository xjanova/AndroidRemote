...
const api: AndroidRemoteApi = {
  ...
  macroSave: (macro) => ipcRenderer.invoke(IPC.macroSave, macro) as Promise<void>,
  macroRunState: () => ipcRenderer.invoke(IPC.macroRunState),
  profileList: () => ipcRenderer.invoke(IPC.profileList),
  profileSave: (profile) => ipcRenderer.invoke(IPC.profileSave, profile) as Promise<void>,
  profileDelete: (serial) => ipcRenderer.invoke(IPC.profileDelete, serial) as Promise<void>,
  templateSets: () => ipcRenderer.invoke(IPC.templateSets),
  templateList: (set) => ipcRenderer.invoke(IPC.templateList, set),
  templateDelete: (set, name) => ipcRenderer.invoke(IPC.templateDelete, set, name) as Promise<void>,
  screenshotPreview: (serial) => ipcRenderer.invoke(IPC.screenshotPreview, serial),
  templateSaveFromPreview: (serial, set, name, rect) => ipcRenderer.invoke(IPC.templateSaveFromPreview, serial, set, name, rect),
  templateTest: (serial, set, name) => ipcRenderer.invoke(IPC.templateTest, serial, set, name),
